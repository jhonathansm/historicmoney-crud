...
import com.example.algamoneyapi.execptionhandler.AlgamoneyExceptionHandler.Erro;
...
public class LancamentoResource {
	...
	@GetMapping("/{codigo}")
	public ResponseEntity<Lancamento> listaPorId(@PathVariable Long codigo) {
	...
	public ResponseEntity<Lancamento> criar(@Valid @RequestBody Lancamento lancamento, HttpServletResponse response) {
		Lancamento lancamentoAtualizado = lancamentoService.salvar(lancamento);
		publisher.publishEvent(new RecursoCriadoEvent(this, response, lancamentoAtualizado.getCodigo()));
		return ResponseEntity.status(HttpStatus.CREATED).body(lancamentoAtualizado);
	}
